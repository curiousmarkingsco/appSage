...
function createRemoveColumnButton(column, gridContainer) {
  ...
  button.className = 'removeColumn ugc-discard  bg-russett-500 top-2 hover:bg-russett-700 text-fuscous-gray-50 font-bold p-2 rounded h-12 w-12 mx-auto';
...
function createAddColumnButton(gridContainer) {
  ...
  menuItem.className = 'addColumn highlightButton hidden w-16 h-12 absolute -bottom-12 left-4 ugc-discard bg-fruit-salad-500 hover:bg-fruit-salad-700 text-fuscous-gray-50 font-bold p-2 rounded-b z-50';
  ...
  menuItem.onclick = function () {
    ...
    newColumn.appendChild(createCopyHtmlSectionButton(newColumn));
