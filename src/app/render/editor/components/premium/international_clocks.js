...
function initializeInternationalClocks(componentContainer) {
  ...
  initializedContainer = componentContainer;
  if (!componentContainer) initializedContainer = document.querySelector('.internationalClocks-container');
  ...
  setInterval(() => updateClock(initializedContainer), 1000);
}
