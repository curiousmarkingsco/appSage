...
function createAddHtmlButton(containingBox) {
  ...
  button.className = 'addContainer highlightButton hidden w-16 h-12 absolute -bottom-12 left-44 ugc-discard bg-fruit-salad-500 hover:bg-fruit-salad-700 text-fuscous-gray-50 font-bold p-2 rounded-b z-50';
...
function createAddContainerButton(containingBox) {
  ...
  button.className = 'addContainer highlightButton hidden w-16 h-12 absolute -bottom-12 left-4 ugc-discard bg-fruit-salad-500 hover:bg-fruit-salad-700 text-fuscous-gray-50 font-bold p-2 rounded-b z-50';
  ...
  button.addEventListener('click', function () {
    ...
    containerContainer.className = 'group w-full min-w-auto max-w-auto min-h-auto h-auto max-h-auto pagecontainer flex ml-0 mr-0 mt-0 mb-0 p-4';
...
function createAddGridButton(containingBox) {
  const button = document.createElement('button');
  button.setAttribute('data-extra-info', tooltips['add-container']);
  button.className = 'addGrid highlightButton hidden w-16 h-12 absolute -bottom-12 left-[21rem] ugc-discard bg-fruit-salad-500 hover:bg-fruit-salad-700 text-fuscous-gray-50 font-bold p-2 rounded-b z-50';
...
function addRemoveContainerButton(container, sidebar) {
  ...
  button.className = 'removeContainer bg-russett-500 hover:bg-russett-700 text-fuscous-gray-50 font-bold p-2 rounded h-12 w-12 mx-auto';
...
function createVerticalMoveContainerButton(container, direction) {
  const button = document.createElement('button');
  button.className = 'moveContainer inline ugc-discard bg-romantic-700 hover:bg-romantic-800 text-fuscous-gray-50 font-bold pt-1 pb-1.5 rounded w-12';
  if (direction == 'up') {
