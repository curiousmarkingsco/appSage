...
async function initializeDashboard() {
  try {
    ...
    // Load pages from IndexedDB and populate the page list
    const container = document.getElementById('pageList');
    const AppstartStorage = await idbGet('AppstartStorage') || { pages: {}, titleIdMap: {}, settings: {} };
    const pageList = AppstartStorage.pages;
