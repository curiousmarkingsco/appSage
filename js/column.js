...
function createHorizontalMoveColumnButton(column, direction) {
  ...
  button.className = 'moveColumn ugc-discard bg-amber-500 hover:bg-amber-700 text-white font-bold p-2 rounded h-12 w-16';
  button.setAttribute('data-extra-info', `Move this column to the ${direction}`);
  if (direction == 'left') {
...
function createRemoveColumnButton(column, gridContainer) {
  ...
  button.className = 'removeColumn ugc-discard  bg-rose-500 top-2 hover:bg-rose-700 text-white font-bold p-2 rounded h-12 w-12 mx-auto';
...
function createAddColumnButton(gridContainer) {
  ...
  menuItem.className = 'addColumn ugc-discard bg-sky-500 hover:bg-sky-700 text-white font-bold p-2 rounded';
