...
function enableEditColumnOnClick(column) {
  ...
  column.addEventListener('click', function (event) {
    ...
    moveButtons.appendChild(createRemoveColumnButton(column, column.parent));
...
function createRemoveColumnButton(column, gridContainer) {
  ...
  button.className = 'removeColumn ugc-discard  bg-red-500 top-2 hover:bg-red-700 text-white font-bold p-2 rounded h-12 w-12 mx-auto';
...
function createAddColumnButton(gridContainer) {
  ...
  menuItem.className = 'addColumn ugc-discard bg-blue-500 hover:bg-blue-700 text-white font-bold p-2 rounded';
