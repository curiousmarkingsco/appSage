...
function createAddContentButton(contentContainer) {
  ...
  button.className = 'addContent ugc-discard z-50 hidden group-hover:block absolute top-2 left-1/2 bg-sky-500 hover:bg-sky-700 text-white font-bold p-2 rounded h-12 w-24';
