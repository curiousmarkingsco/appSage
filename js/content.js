...
function createAddContentButton(contentContainer) {
  ...
  button.className = 'addContent ugc-discard z-50 hidden group-hover:block absolute bottom-2 left-[calc(50%-3rem)] bg-sky-500 hover:bg-sky-700 text-white font-bold p-2 rounded h-12 w-24';
...
function createRemoveContentButton(contentContainer) {
  ...
  button.className = 'removeContent ugc-discard bg-rose-500 hover:bg-rose-700 text-white font-bold p-2 rounded h-12 w-12 mx-auto';
...
function createVerticalMoveContentButton(contentContainer, direction) {
  ...
  button.className = 'moveContent ugc-discard bg-amber-500 hover:bg-amber-700 text-white font-bold p-2 rounded h-12 w-16';
  if (direction == 'up') {
...
function showNewContentMenu(contentTypes, sidebar) {
  contentTypes.forEach(type => {
    const button = document.createElement('button');
    button.className = 'bg-sky-500 hover:bg-sky-700 text-white font-bold p-2 rounded m-2 h-24 w-24';
...
function updateSidebarForForm(contentContainer, newContent) {
  ...
  if (!form) {
    ...
    submitButton.className = 'mt-4 bg-emerald-500 hover:bg-emerald-700 top-2 text-white font-bold p-2 rounded';
  ...
  addButton.className = 'bg-sky-500 hover:bg-sky-700 text-white font-bold py-1.5 px-4 rounded-r mr-2 mt-2 inline-block';
...
function updateSidebarFields(form, sidebarForm, submitButton, inputTypes) {
  ...
  form.querySelectorAll('input, select, textarea').forEach(input => {
    ...
    deleteButton.className = 'bg-rose-500 hover:bg-rose-700 text-white font-bold py-1.5 px-4 rounded mt-2 inline-block';
