...
function addGridOptions(grid) {
  ...
  fullWidthOption.className = 'bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mr-2';
  ...
  fixedWidthOption.className = 'bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded';
