...
function addGridOptions(grid) {
  ...
  if (grid) {
    ...
    moveButtons.appendChild(createVerticalMoveGridButton(grid, 'up'));
    moveButtons.appendChild(addRemoveGridButton(grid, sidebar));
    moveButtons.appendChild(createVerticalMoveGridButton(grid, 'down'));
...
function addRemoveGridButton(grid, sidebar) {
  ...
  button.className = 'bg-red-500 hover:bg-red-700 text-white font-bold p-2 rounded h-12 w-12';
