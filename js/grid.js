...
function addRemoveGridButton(grid, sidebar) {
  ...
  button.className = 'removeGrid bg-rose-500 hover:bg-rose-700 text-white font-bold p-2 rounded h-12 w-12 mx-auto';
...
function createVerticalMoveGridButton(grid, direction) {
  ...
  button.className = 'moveGrid inline ugc-discard bg-amber-500 hover:bg-amber-700 text-white font-bold pt-1 pb-1.5 rounded w-12';
  if (direction == 'up') {
...
function addGridAlignmentOptions(sidebar, grid) {
  ...
  function addGenericGridOptions(labelPrefix, cssClassBase, options) {
    ...
    breakpoints.forEach(bp => {
      ...
      select.className = 'shadow border rounded py-2 px-3 text-slate-700 leading-tight focus:outline-none focus:shadow-outline';
